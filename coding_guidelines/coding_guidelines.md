...
* **root/build/docs/doxygen** folder contains files generated by Doxygen.
* **root/build/docs/doxygen/html** folder contains API documentation html files generated by Doxygen.
* **root/docs** folder contains markdown documentation.
* **root/docs/doxygen** folder contains data files used as input to Doxygen.
* **root/docs/doxygen/include** folder contains documentation files used as input to Doxygen.
